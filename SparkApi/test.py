...
btn.place(relx=0.77, rely=0.03, relwidth=0.1, relheight=0.05)

btn1 = Button(win, text="清除", command=clearbuild)
btn1.place(relx=0.88, rely=0.03, relwidth=0.08, relheight=0.05)
